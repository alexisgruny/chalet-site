...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/chalet/exterieur-facade-hiver-sapin.jpg", // ← idéalement une image 1200×630
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/images/chalet/exterieur-facade-hiver-sapin.jpg"],
  },
};
...
const jsonLd = {
  ...
  "url": "https://chalet-jaia.fr",
  "image": "https://chalet-jaia.fr/images/chalet/exterieur-facade-hiver-sapin.jpg",
  "address": {
    "@type": "PostalAddress",
